...
type TransformerClient interface {
	...
	Appversion(ctx context.Context, in *CheckversionReq, opts ...grpc.CallOption) (*CheckversionResp, error)
}
...
func (c *transformerClient) Appversion(ctx context.Context, in *CheckversionReq, opts ...grpc.CallOption) (*CheckversionResp, error) {
	out := new(CheckversionResp)
	err := c.cc.Invoke(ctx, "/transform.transformer/appversion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransformerServer interface {
	...
	Appversion(context.Context, *CheckversionReq) (*CheckversionResp, error)
...
func (UnimplementedTransformerServer) Appversion(context.Context, *CheckversionReq) (*CheckversionResp, error) {
...
func _Transformer_Appversion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckversionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransformerServer).Appversion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/transform.transformer/appversion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransformerServer).Appversion(ctx, req.(*CheckversionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Transformer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Transformer_Appversion_Handler,
		},
	},
