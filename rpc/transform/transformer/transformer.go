...
type (
	CheckversionReq  = transform.CheckversionReq
	CheckversionResp = transform.CheckversionResp
...
func (m *defaultTransformer) Appversion(ctx context.Context, in *CheckversionReq, opts ...grpc.CallOption) (*CheckversionResp, error) {
	client := transform.NewTransformerClient(m.cli.Conn())
	return client.Appversion(ctx, in, opts...)
}
